...
export abstract class LoggerType {
  private colors: any = {
  ...
  getColor(level: LoggingLevel) {
    ...
    let colorTousle: Record<string, unknown> | string = this.colors[logName] || 'black';
 ...
 * @returns {any} returns a logger
 */
export class LoggerFactory {
  static getLogger = (name = 'console'): LoggerType => {
